...
*pending* — the questionnaire has not been run for plugins, the Skills view, hook trust, or
Agent notes. The design's maintainer decisions (2026-09-25) are recorded in the
