...
half-built items today: chat sessions aren't yet resurrected across a daemon restart
(they retire to Recents — see [lifecycle-and-persistence.md](lifecycle-and-persistence.md));
Codex chat drops the create-time model; Gemini/Antigravity aren't first-class agents yet
