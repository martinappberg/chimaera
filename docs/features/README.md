...
| [board.md](board.md) | Board — the `.board` visual composition surface (JSON; legacy `.board.json` opens): the chimaera-board engine, `board show/new/render/describe/lint`, the render/describe/edit routes, the BoardView pane, the bidirectional gesture loop |
