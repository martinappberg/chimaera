...
because branch protection already required CI green on the merge. Published releases carry a
`latest.json` the installed app polls to auto-update itself; the download is verified against
