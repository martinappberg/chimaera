...
| `crates/chimaera-board` | the board engine: `.board` schema (JSON; legacy `.board.json` opens), themes, chart, render | [map](crates/chimaera-board/AGENTS.md) · [plan](docs/board-plan.md) |
