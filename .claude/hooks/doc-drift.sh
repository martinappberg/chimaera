...
check 'web-ui/src/lib/knowledge/'     'web-ui/src/lib/knowledge/AGENTS.md' 'knowledge UI'
check 'web-ui/src/lib/plugins/'       'web-ui/src/lib/plugins/AGENTS.md'   'plugins UI'
...
check 'crates/chimaera-server/src/environment.rs' 'docs/features/environment.md'   'feature: environment'
check 'crates/chimaera-server/src/compute.rs' 'docs/features/compute.md'            'feature: compute'
...
check 'crates/chimaera-server/src/doc_check.rs' 'docs/features/agents.md'          'feature: agents'
check 'crates/chimaera-server/src/agent_docs.rs' 'docs/features/agents.md'         'feature: agents'
...
check 'crates/chimaera-server/src/timeline.rs'  'docs/features/timeline-and-knowledge.md' 'feature: timeline & knowledge'
check 'crates/chimaera-server/src/episodes.rs'  'docs/features/timeline-and-knowledge.md' 'feature: timeline & knowledge'
check 'crates/chimaera-server/src/knowledge.rs' 'docs/features/timeline-and-knowledge.md' 'feature: timeline & knowledge'
check 'plugins/mycelium/'                       'docs/features/timeline-and-knowledge.md' 'feature: timeline & knowledge'
check 'web-ui/src/lib/knowledge/'     'docs/features/timeline-and-knowledge.md'    'feature: timeline & knowledge'
check 'web-ui/src/lib/workspace/[Tt]imeline' 'docs/features/timeline-and-knowledge.md' 'feature: timeline & knowledge'
...
check 'plugins/agent-notes/'                    'docs/features/plugins.md'         'feature: plugins'
...
check 'web-ui/src/lib/plugins/'       'docs/features/plugins.md'                   'feature: plugins'
